...
from apps.Gestor.views import index_gestor, iniciativa_view, iniciativa_edit, iniciativa_list, iniciativalist,  asignacion_list, asignacion_edit, asignacion_delete, asignacionlist, AsignacionCreate
...
urlpatterns = [
    ...
    url(r'^nuevo_asignacion$', AsignacionCreate.as_view(), name = 'Asignacion_crear'),
